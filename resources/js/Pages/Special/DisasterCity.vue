...
import { cities } from '@/Pages/Contacts/data/mainBoardSpots.js';

defineOptions({ layout: AppLayout });

const tone = 'border-orange-300/60 bg-orange-700/90 text-orange-50';
...
<template>
    <Breadcrumb title="City" parent="Other › Disaster" />
